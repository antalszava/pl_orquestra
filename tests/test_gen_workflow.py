...
class TestExpvalTemplate:
    ...
    @pytest.mark.parametrize("resources, test_wf", [(None, test_workflow), (resources_default, test_workflow_resources)])
    def test_matches_template(self, resources, test_wf):
        ...
        workflow = gw.expval_template(
            backend_component, backend_specs_default, circuits, operator_string_default, resources=resources
        )
        ...
        # Checking the inputs
        assert workflow['steps'][0]['inputs'][0]['backend_specs'] == test_wf['steps'][0]['inputs'][0]['backend_specs']
        assert workflow['steps'][0]['inputs'][3]['operators'] == test_wf['steps'][0]['inputs'][3]['operators']
        assert workflow['steps'][0]['inputs'][4]['circuit'] == test_wf['steps'][0]['inputs'][4]['circuit']
        ...
        # Checking the inputs
        assert workflow['steps'][1]['inputs'][0]['backend_specs'] == test_wf['steps'][1]['inputs'][0]['backend_specs']
        assert workflow['steps'][1]['inputs'][3]['operators'] == test_wf['steps'][1]['inputs'][3]['operators']
        assert workflow['steps'][1]['inputs'][4]['circuit'] == test_wf['steps'][1]['inputs'][4]['circuit']
